...
class LoginView(Frame):
    ...
    def create_ui(self, presenter):
        ...
        self.registering = Button(
            self, text="Register", command=self._presenter.on_register_button_clicked)
...
class MainView(Frame):
    def __init__(self, parent):
        ...
        self._parent.menu.add_cascade(
            label="Themes", menu=self._parent.theme_menu)
    ...
    def create_ui(self, presenter):
        ...
        Label(self, text="Welcome, to the trading app!").grid(
        ...
        self.rl_tab = RLTab(self.notebook, self._presenter)
