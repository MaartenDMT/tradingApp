...
class TradingEnvironment(gym.Env):
    ...
    def step(self, action):
        ...
        self.logger.info(
            f"action_type: {action_type}, percentage: {percentage}")
        ...
        self.logger.info(
            f"action:{action_type}| balance: {self.balance} | price: {current_price} dots: {self.candlestick_data['dots'].iloc[self.current_step]}| waves: {self.candlestick_data['b_wave'].iloc[self.current_step]} ")
