...
from model.reinforcement.algorithms.tensorflow.TF.MAPDDG.agent2 import \
    MAPDDGAgent
from model.reinforcement.environments import TradingEnvironment
from model.reinforcement.utils.visualization.visual_plot import plotLearning
...
if __name__ == '__main__':
    ...
    env = TradingEnvironment(symbol='BTCUSDT', features=[
