...
def worker(name, input_shape, n_actions, global_agent, global_icm,
           optimizer, icm_optimizer, env_id, n_threads, icm=False, rl_logger=None):
    T_MAX = 20
    ...
    while episode < max_eps:
        ...
        if name == '1':
            ...
            rl_logger.info('{} episode {} thread {} of {} steps {:.2f}M score {:.2f} '
    ...
    if name == '1':
        ...
        fname = algo + f'icm_torch_{req}.png'
