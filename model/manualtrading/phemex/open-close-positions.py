...
stopMarketOrder = exchange.create_order(symbol, 'Stop', 'buy', amount, None, {
                                        'stopPx': 70000})  # default triggerType is ByMarkPrice
...
stopLimitOrder = exchange.create_order(symbol, 'StopLimit', 'buy', amount, 20000, {
                                       'stopPx': 70000, "triggerType": "ByLastPrice"})
...
orderClose = exchange.create_order(
...
order = exchange.create_order(symbol, 'market', 'buy', amount, None, {
                              'stopLossPrice': 5000, 'takeProfitPrice': 100000})
